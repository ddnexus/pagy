...
!!!
The API is documented here, however you should use the [keyset_for_ui extra](/docs/toolbox/paginator/keyset_for_ui.md)
...
This section integrates the [Keyset Glossary](keynav.md#glossary)
...
the [Keyset documentation](/docs/toolbox/keyset.md#understanding-the-cutoffs):
