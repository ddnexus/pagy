...
+ gem 'pagy', '~> 43.6.1', require: 'pagy/next' # PATCH version restriction + pagy/next entry point
```
...
- Use a stricter PATCH version restriction (e.g., replace `~> 43.6` with `~> 43.6.1`)
