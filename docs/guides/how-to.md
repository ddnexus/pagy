...
Pagy uses standard i18n dictionaries to translate its string and allow overriding. (see [Pagy::I18n documentation](../resources/i18n.md).)
...
See more details in the [ARIA attributes Page](../resources/ARIA.md).
