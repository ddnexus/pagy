...
This module provides the Pagy implementation of the i18n `translation` method used internally (see [pagy_t](frontend/#pagy-t-key-vars)). It's ~18x faster and uses ~10x less memory than the standard `i18n` gem.
