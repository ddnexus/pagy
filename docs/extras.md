...
| `calendar`            | Add pagination filtering by calendar time unit (Year, Month, Week Day)                                                                                     | [calendar.rb](https://github.com/ddnexus/pagy/blob/master/lib/pagy/extras/countless.rb), [documentation](extras/calendar.md)                                 |
