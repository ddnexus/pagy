...
| `calendar`            | Paginate a collection by calendar Time unit (year, month, week or day)                                                                                   | [calendar.rb](https://github.com/ddnexus/pagy/blob/master/lib/pagy/extras/countless.rb), [documentation](extras/calendar.md)                                 |
