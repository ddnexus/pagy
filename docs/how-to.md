...
Alternatively you may choose to paginate [two different models in the same page (https://www.imaginarycloud.com/blog/how-to-paginate-ruby-on-rails-apps-with-pagy/):
