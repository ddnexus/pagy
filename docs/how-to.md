...
Pagy should work out of the box for most Rack based apps (e.g. Rails) even without configuring anything, however you can configure all its features by creating a `pagy.rb` initializer file, copying the content of the [initializer-example.rb](https://github.com/ddnexus/pagy/blob/master/lib/pagy/extras/initializer-example.rb) and uncomment and edit what you may need.
