...
describe Pagy::Frontend do
  ...
  describe "#pagy_link_proc" do
    ...
    it 'renders with extras' do
      pagy = Pagy.new count: 103, page: 1
      view.pagy_link_proc(pagy, "X").call(1).must_equal '<a href="/foo?page=1"  X >1</a>'
    end
  ...
  describe "#pagy_t" do
    ...
    it 'interpolates' do
      ...
      view.pagy_t('pagy.info.single_page', count: 1).must_equal "Displaying <b>1</b> %{item_name}"
      view.pagy_t('pagy.info.single_page', count: 10).must_equal "Displaying <b>10</b> %{item_name}"
      view.pagy_t('pagy.info.multiple_pages', count: 10).must_equal "Displaying %{item_name} <b>%{from}-%{to}</b> of <b>10</b> in total"
      view.pagy_t('pagy.info.multiple_pages', item_name: 'Products', count: 300, from: 101, to: 125).must_equal "Displaying Products <b>101-125</b> of <b>300</b> in total"
    end
  ...
  describe "#pagy_info" do
    ...
    it 'renders with existing i18n path' do
      ...
      view.pagy_info(Pagy.new count: 1, i18n_key: 'pagy.info.product').must_equal "Displaying <b>1</b> Product"
      view.pagy_info(Pagy.new count: 13, i18n_key: 'pagy.info.product').must_equal "Displaying <b>13</b> Products"
      view.pagy_info(Pagy.new count: 100, i18n_key: 'pagy.info.product', page: 3).must_equal "Displaying Products <b>41-60</b> of <b>100</b> in total"
      Pagy::I18n.load(locale: 'en') # reset for other tests
    end
  end
