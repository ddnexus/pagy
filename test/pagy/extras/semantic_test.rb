...
describe Pagy::Frontend do
  ...
  describe "#pagy_nav_compact_semantic" do
    ...
    it 'renders page 1' do
      pagy, _  = @array.pagy(1)
      html, id = frontend.pagy_nav_compact_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-compact-semantic ui compact menu\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"  class=\"item\" style=\"display: none;\" ></a><div class=\"item disabled\"><i class=\"left small chevron icon\"></i></div><div class=\"pagy-compact-input item\">Page <input type=\"number\" min=\"1\" max=\"6\" value=\"1\" style=\"padding: 0; text-align: center; width: 2rem; margin: 0 0.3rem\"> of 6</div> <a href=\"/foo?page=2\"  class=\"item\" rel=\"next\" aria-label=\"next\"><i class=\"right small chevron icon\"></i></a></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"#{id}\", \"#{Pagy::Frontend::MARKER}\", \"1\", false]</script>"
    end
    ...
    it 'renders page 3' do
      ...
      html, id = frontend.pagy_nav_compact_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-compact-semantic ui compact menu\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"  class=\"item\" style=\"display: none;\" ></a><a href=\"/foo?page=2\"  class=\"item\" rel=\"prev\" aria-label=\"previous\"><i class=\"left small chevron icon\"></i></a><div class=\"pagy-compact-input item\">Page <input type=\"number\" min=\"1\" max=\"6\" value=\"3\" style=\"padding: 0; text-align: center; width: 2rem; margin: 0 0.3rem\"> of 6</div> <a href=\"/foo?page=4\"  class=\"item\" rel=\"next\" aria-label=\"next\"><i class=\"right small chevron icon\"></i></a></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"#{id}\", \"#{Pagy::Frontend::MARKER}\", \"3\", false]</script>"
    end
    ...
    it 'renders page 6' do
      ...
      html, id = frontend.pagy_nav_compact_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-compact-semantic ui compact menu\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"  class=\"item\" style=\"display: none;\" ></a><a href=\"/foo?page=5\"  class=\"item\" rel=\"prev\" aria-label=\"previous\"><i class=\"left small chevron icon\"></i></a><div class=\"pagy-compact-input item\">Page <input type=\"number\" min=\"1\" max=\"6\" value=\"6\" style=\"padding: 0; text-align: center; width: 2rem; margin: 0 0.3rem\"> of 6</div> <div class=\"item disabled\"><i class=\"right small chevron icon\"></i></div></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"#{id}\", \"#{Pagy::Frontend::MARKER}\", \"6\", false]</script>"
    end

  end

  describe "#pagy_nav_responsive_semantic" do
    ...
    it 'renders page 1' do
      pagy, _  = @array.pagy(1)
      html, id = frontend.pagy_nav_responsive_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-responsive-semantic ui pagination menu\" role=\"navigation\" aria-label=\"pager\"></div><script type=\"application/json\" class=\"pagy-responsive-json\">[\"#{id}\", {\"before\":\"<div class=\\\"item disabled\\\"><i class=\\\"left small chevron icon\\\"></i></div>\",\"1\":\"<a class=\\\"item active\\\">1</a>\",\"2\":\"<a href=\\\"/foo?page=2\\\"  class=\\\"item\\\" rel=\\\"next\\\" >2</a>\",\"3\":\"<a href=\\\"/foo?page=3\\\"  class=\\\"item\\\" >3</a>\",\"4\":\"<a href=\\\"/foo?page=4\\\"  class=\\\"item\\\" >4</a>\",\"5\":\"<a href=\\\"/foo?page=5\\\"  class=\\\"item\\\" >5</a>\",\"6\":\"<a href=\\\"/foo?page=6\\\"  class=\\\"item\\\" >6</a>\",\"after\":\"<a href=\\\"/foo?page=2\\\"  class=\\\"item\\\" rel=\\\"next\\\" aria-label=\\\"next\\\"><i class=\\\"right small chevron icon\\\"></i></a>\"},  [0], {\"0\":[\"1\",2,3,4,5,6]}]</script>"
    end
    ...
    it 'renders page 3' do
      ...
      html, id = frontend.pagy_nav_responsive_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-responsive-semantic ui pagination menu\" role=\"navigation\" aria-label=\"pager\"></div><script type=\"application/json\" class=\"pagy-responsive-json\">[\"#{id}\", {\"before\":\"<a href=\\\"/foo?page=2\\\"  class=\\\"item\\\" rel=\\\"prev\\\" aria-label=\\\"previous\\\"><i class=\\\"left small chevron icon\\\"></i></a>\",\"1\":\"<a href=\\\"/foo?page=1\\\"  class=\\\"item\\\" >1</a>\",\"2\":\"<a href=\\\"/foo?page=2\\\"  class=\\\"item\\\" rel=\\\"prev\\\" >2</a>\",\"3\":\"<a class=\\\"item active\\\">3</a>\",\"4\":\"<a href=\\\"/foo?page=4\\\"  class=\\\"item\\\" rel=\\\"next\\\" >4</a>\",\"5\":\"<a href=\\\"/foo?page=5\\\"  class=\\\"item\\\" >5</a>\",\"6\":\"<a href=\\\"/foo?page=6\\\"  class=\\\"item\\\" >6</a>\",\"after\":\"<a href=\\\"/foo?page=4\\\"  class=\\\"item\\\" rel=\\\"next\\\" aria-label=\\\"next\\\"><i class=\\\"right small chevron icon\\\"></i></a>\"},  [0], {\"0\":[1,2,\"3\",4,5,6]}]</script>"
    end
    ...
    it 'renders page 6' do
      ...
      html, id = frontend.pagy_nav_responsive_semantic(pagy), caller(0,1)[0].hash
      html.must_equal \
        "<div id=\"pagy-nav-#{id}\" class=\"pagy-nav-responsive-semantic ui pagination menu\" role=\"navigation\" aria-label=\"pager\"></div><script type=\"application/json\" class=\"pagy-responsive-json\">[\"#{id}\", {\"before\":\"<a href=\\\"/foo?page=5\\\"  class=\\\"item\\\" rel=\\\"prev\\\" aria-label=\\\"previous\\\"><i class=\\\"left small chevron icon\\\"></i></a>\",\"1\":\"<a href=\\\"/foo?page=1\\\"  class=\\\"item\\\" >1</a>\",\"2\":\"<a href=\\\"/foo?page=2\\\"  class=\\\"item\\\" >2</a>\",\"3\":\"<a href=\\\"/foo?page=3\\\"  class=\\\"item\\\" >3</a>\",\"4\":\"<a href=\\\"/foo?page=4\\\"  class=\\\"item\\\" >4</a>\",\"5\":\"<a href=\\\"/foo?page=5\\\"  class=\\\"item\\\" rel=\\\"prev\\\" >5</a>\",\"6\":\"<a class=\\\"item active\\\">6</a>\",\"after\":\"<div class=\\\"item disabled\\\"><i class=\\\"right small chevron icon\\\"></i></div>\"},  [0], {\"0\":[1,2,3,4,5,\"6\"]}]</script>"
    end
