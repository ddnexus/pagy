...
describe 'pagy/extras/uikit' do
  ...
  describe '#pagy_uikit_nav' do
    ...
    it 'should raise for wrong series' do
      _ { view.pagy_uikit_nav(PagyBuggy.new(count:100)) }.must_raise Pagy::InternalError
    end
  end
  ...
  describe '#pagy_uikit_nav_js' do
    ...
    it 'raises with missing step 0' do
      ...
      _ { view.pagy_uikit_nav_js(pagy, steps: { 600 => [1, 3, 3, 1] }) }.must_raise Pagy::VariableError
    end
  end
