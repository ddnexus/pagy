...
describe 'pagy/extras/uikit' do
  ...
  describe '#pagy_uikit_nav' do
    it 'renders first page' do
      ...
      _(app.pagy_uikit_nav(pagy)).must_rematch
      _(app.pagy_uikit_nav(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra')).must_rematch
    end
  ...
  describe '#pagy_uikit_combo_nav' do
    it 'renders first page' do
      pagy = Pagy.new(count: 1000, page: 1)
      _(app.pagy_uikit_combo_nav_js(pagy)).must_rematch
      _(app.pagy_uikit_combo_nav_js(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra')).must_rematch
    end
    it 'renders intermediate page' do
      pagy = Pagy.new(count: 1000, page: 20)
      _(app.pagy_uikit_combo_nav_js(pagy)).must_rematch
