...
describe Pagy::Frontend do
  ...
  describe "#pagy_nav_responsive" do
    ...
    def test_pagy_nav_responsive_page_1
      ...
      assert_equal(
      %(<nav id="pagy-nav-#{id}" class="pagy-nav-responsive pagination" role="navigation" aria-label="pager"></nav><script>PagyResponsive('#{id}', {'prev':'<span class="page prev disabled">&lsaquo;&nbsp;Prev</span> ','1':'<span class="page active">1</span> ','2':'<span class="page"><a href="/foo?page=2"   rel="next" >2</a></span> ','3':'<span class="page"><a href="/foo?page=3"   >3</a></span> ','4':'<span class="page"><a href="/foo?page=4"   >4</a></span> ','5':'<span class="page"><a href="/foo?page=5"   >5</a></span> ','6':'<span class="page"><a href="/foo?page=6"   >6</a></span> ','next':'<span class="page next"><a href="/foo?page=2"   rel="next" aria-label="next">Next&nbsp;&rsaquo;</a></span>'}, [0], {"0":["1",2,3,4,5,6]});</script>),
      html
      )
    end
