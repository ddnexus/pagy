  ...
  describe "#pagy_nav_compact" do
    ...
    it 'renders page 1' do
      ...
      html.must_equal \
        %(<nav id="pagy-nav-#{id}" class="pagy-nav-compact pagination" role="navigation" aria-label="pager">) +
          ...
          %(<a href="/foo"   style="display: none;" ></a>) +
        ...
        %(</nav>) +
        %(<script type="application/json" class="pagy-compact-json">["#{id}", "#{Pagy::Frontend::MARKER}", "1", true]</script>)
    end
    ...
    it 'renders page 3' do
      ...
      html.must_equal \
        ...
        %(</nav>) +
        %(<script type="application/json" class="pagy-compact-json">["#{id}", "#{Pagy::Frontend::MARKER}", "3", true]</script>)
    end
    ...
    it 'renders page 6' do
      ...
      html.must_equal \
        ...
        %(</nav>) +
        %(<script type="application/json" class="pagy-compact-json">["#{id}", "#{Pagy::Frontend::MARKER}", "6", true]</script>)
    end
