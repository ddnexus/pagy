...
describe 'pagy/extras/standalone_items' do
  ...
  describe '#pagy_url_for' do
    it 'renders url with params and fragment' do
      ...
      _(app.pagy_url_for(pagy, 5)).must_equal "http://www.pagy-standalone.com/subdir?a%5B%5D=1&a%5B%5D=2&a%5B%5D=3&page=5&items=20#fragment"
      _(app.pagy_url_for(pagy, 5, absolute: true)).must_equal "http://www.pagy-standalone.com/subdir?a%5B%5D=1&a%5B%5D=2&a%5B%5D=3&page=5&items=20#fragment"
