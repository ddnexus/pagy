...
describe 'pagy/extras/standalone_items' do
  ...
  describe '#pagy_url_for' do
    it 'renders url with params and fragment' do
      ...
      _(app.pagy_url_for(pagy, 5, html_escaped: true)).must_equal "/foo?page=5&amp;a=3&amp;b=4&amp;items=20#fragment"
      _(app.pagy_url_for(pagy, 5, absolute: true)).must_equal "http://example.com:3000/foo?page=5&a=3&b=4&items=20#fragment"
      _(app.pagy_url_for(pagy, 5, absolute: true, html_escaped: true)).must_equal "http://example.com:3000/foo?page=5&amp;a=3&amp;b=4&amp;items=20#fragment"
      ...
      _(app.pagy_url_for(pagy, 5, html_escaped: true)).must_equal "http://www.pagy-standalone.com/subdir?a[]=1&amp;a[]=2&amp;a[]=3&amp;page=5&amp;items=20#fragment"
      ...
      _(app.pagy_url_for(pagy, 5, absolute: true, html_escaped: true)).must_equal "http://www.pagy-standalone.com/subdir?a[]=1&amp;a[]=2&amp;a[]=3&amp;page=5&amp;items=20#fragment"
      ...
      _(app.pagy_url_for(pagy, 5, html_escaped: true)).must_equal "?a&amp;page=5&amp;items=20#fragment"
      _(app.pagy_url_for(pagy, 5, absolute: true)).must_equal "?a&page=5&items=20#fragment"
      _(app.pagy_url_for(pagy, 5, absolute: true, html_escaped: true)).must_equal "?a&amp;page=5&amp;items=20#fragment"
    end
  end
end
