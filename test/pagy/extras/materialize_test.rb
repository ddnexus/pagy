...
describe Pagy::Frontend do
  ...
  describe "#pagy_materialize_compact_nav" do
    ...
    it 'renders page 1 for materialize' do
      ...
      html.must_equal \
        "<div id=\"pagy-nav-test-id\" class=\"pagy-nav-compact-materialize pagy-materialize-compact-nav pagination\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"   style=\"display: none;\" ></a><div class=\"pagy-compact-chip role=\"group\" style=\"height: 35px; border-radius: 18px; background: #e4e4e4; display: inline-block;\"><ul class=\"pagination\" style=\"margin: 0px;\"><li class=\"prev disabled\" style=\"vertical-align: middle;\"><a href=\"#\"><i class=\"material-icons\">chevron_left</i></a></li><div class=\"pagy-compact-input btn-flat\" style=\"cursor: default; padding: 0px\">Page <input type=\"number\" class=\"browser-default\" min=\"1\" max=\"6\" value=\"1\" style=\"padding: 2px; border: none; border-radius: 2px; text-align: center; width: 2rem;\"> of 6</div><li class=\"waves-effect next\" style=\"vertical-align: middle;\"><a href=\"/foo?page=2\"   rel=\"next\" aria-label=\"next\"><i class=\"material-icons\">chevron_right</i></a></li></ul></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"test-id\", \"#{Pagy::Frontend::MARKER}\", \"1\", false]</script>"
    end
    ...
    it 'renders page 3 for materialize' do
      ...
      html = frontend.pagy_materialize_compact_nav(pagy, pagy_test_id)
      html.must_equal \
        "<div id=\"pagy-nav-test-id\" class=\"pagy-nav-compact-materialize pagy-materialize-compact-nav pagination\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"   style=\"display: none;\" ></a><div class=\"pagy-compact-chip role=\"group\" style=\"height: 35px; border-radius: 18px; background: #e4e4e4; display: inline-block;\"><ul class=\"pagination\" style=\"margin: 0px;\"><li class=\"waves-effect prev\" style=\"vertical-align: middle;\"><a href=\"/foo?page=2\"   rel=\"prev\" aria-label=\"previous\"><i class=\"material-icons\">chevron_left</i></a></li><div class=\"pagy-compact-input btn-flat\" style=\"cursor: default; padding: 0px\">Page <input type=\"number\" class=\"browser-default\" min=\"1\" max=\"6\" value=\"3\" style=\"padding: 2px; border: none; border-radius: 2px; text-align: center; width: 2rem;\"> of 6</div><li class=\"waves-effect next\" style=\"vertical-align: middle;\"><a href=\"/foo?page=4\"   rel=\"next\" aria-label=\"next\"><i class=\"material-icons\">chevron_right</i></a></li></ul></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"test-id\", \"#{Pagy::Frontend::MARKER}\", \"3\", false]</script>"
    end
    ...
    it 'renders page 6 for materialize' do
      ...
      html = frontend.pagy_materialize_compact_nav(pagy, pagy_test_id)
      html.must_equal \
        "<div id=\"pagy-nav-test-id\" class=\"pagy-nav-compact-materialize pagy-materialize-compact-nav pagination\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"   style=\"display: none;\" ></a><div class=\"pagy-compact-chip role=\"group\" style=\"height: 35px; border-radius: 18px; background: #e4e4e4; display: inline-block;\"><ul class=\"pagination\" style=\"margin: 0px;\"><li class=\"waves-effect prev\" style=\"vertical-align: middle;\"><a href=\"/foo?page=5\"   rel=\"prev\" aria-label=\"previous\"><i class=\"material-icons\">chevron_left</i></a></li><div class=\"pagy-compact-input btn-flat\" style=\"cursor: default; padding: 0px\">Page <input type=\"number\" class=\"browser-default\" min=\"1\" max=\"6\" value=\"6\" style=\"padding: 2px; border: none; border-radius: 2px; text-align: center; width: 2rem;\"> of 6</div><li class=\"next disabled\" style=\"vertical-align: middle;\"><a href=\"#\"><i class=\"material-icons\">chevron_right</i></a></li></ul></div><script type=\"application/json\" class=\"pagy-compact-json\">[\"test-id\", \"#{Pagy::Frontend::MARKER}\", \"6\", false]</script>"
    end
  ...
  describe "#pagy_materialize_responsive_nav" do
    ...
    it 'renders page 1 for materialize' do
      ...
      html.must_equal \
        "<div id=\"pagy-nav-test-id\" class=\"pagy-nav-responsive-materialize pagy-materialize-responsive-nav pagination\" role=\"navigation\" aria-label=\"pager\"></div><script type=\"application/json\" class=\"pagy-responsive-json\">[\"test-id\", {\"before\":\"<ul class=\\\"pagination\\\"><li class=\\\"prev disabled\\\"><a href=\\\"#\\\"><i class=\\\"material-icons\\\">chevron_left</i></a></li>\",\"1\":\"<li class=\\\"active\\\"><a href=\\\"/foo?page=1\\\"   >1</a></li>\",\"2\":\"<li class=\\\"waves-effect\\\"><a href=\\\"/foo?page=2\\\"   rel=\\\"next\\\" >2</a></li>\",\"3\":\"<li class=\\\"waves-effect\\\"><a href=\\\"/foo?page=3\\\"   >3</a></li>\",\"4\":\"<li class=\\\"waves-effect\\\"><a href=\\\"/foo?page=4\\\"   >4</a></li>\",\"5\":\"<li class=\\\"waves-effect\\\"><a href=\\\"/foo?page=5\\\"   >5</a></li>\",\"6\":\"<li class=\\\"waves-effect\\\"><a href=\\\"/foo?page=6\\\"   >6</a></li>\",\"after\":\"<li class=\\\"waves-effect next\\\"><a href=\\\"/foo?page=2\\\"   rel=\\\"next\\\" aria-label=\\\"next\\\"><i class=\\\"material-icons\\\">chevron_right</i></a></li></ul>\"},  [0], {\"0\":[\"1\",2,3,4,5,6]}]</script>"
    end
