...
describe 'pagy/extras/support' do
  ...
  describe '#pagy_prev_link' do
    it 'renders the prev link for page 1' do
      pagy = Pagy.new count: 1000, page: 1
      pagy_countless = Pagy::Countless.new(page: 1).finalize(21)
      _(view.pagy_prev_link(pagy)).must_rematch
  ...
  describe '#pagy_next_link' do
    it 'renders the next link for page 1' do
      pagy = Pagy.new count: 1000, page: 1
      pagy_countless = Pagy::Countless.new(page: 1).finalize(21)
      _(view.pagy_next_link(pagy)).must_rematch
      _(view.pagy_next_link(pagy_countless)).must_rematch
      _(view.pagy_next_link(pagy, text: 'NEXT', link_extra: 'link-extra')).must_rematch
      _(view.pagy_next_link(pagy_countless, text: 'NEXT', link_extra: 'link-extra')).must_rematch
    end
  ...
  describe '#pagy_prev_link_tag' do
    ...
    it 'renders the prev link tag for page 3' do
      pagy = Pagy.new count: 1000, page: 3
      pagy_countless = Pagy::Countless.new(page: 3).finalize(21)
      _(view.pagy_prev_link_tag(pagy)).must_rematch
      _(view.pagy_prev_link_tag(pagy_countless)).must_rematch
    end
  ...
  describe '#pagy_next_link_tag' do
    it 'renders the next link tag for page 1' do
      pagy = Pagy.new count: 1000, page: 1
      pagy_countless = Pagy::Countless.new(page: 1).finalize(21)
      _(view.pagy_next_link_tag(pagy)).must_rematch
      _(view.pagy_next_link_tag(pagy_countless)).must_rematch
    end
