...
describe Pagy::Frontend do
  ...
  describe "#pagy_nav_foundation" do
    ...
    it 'renders page 1' do
      ...
      frontend.pagy_nav_foundation(pagy).must_equal \
        '<nav class="pagy-nav-foundation" aria-label="Pagination">' \
          '<ul class="pagination">' \
            '<li class="pagination-previous disabled">&lsaquo;&nbsp;Prev</li>' \
            ...
            '<li class="pagination-next"><a href="/foo?page=2"   rel="next" aria-label="next">Next&nbsp;&rsaquo;</a></li>' \
          '</ul>' \
        '</nav>'
    end
    ...
    it 'renders page 3' do
      ...
      '<nav class="pagy-nav-foundation" aria-label="Pagination">' \
        '<ul class="pagination">' \
          '<li class="pagination-previous"><a href="/foo?page=2"   rel="prev" aria-label="previous">&lsaquo;&nbsp;Prev</a></li>' \
          ...
          '<li><a href="/foo?page=5"   >5</a></li>' \
          '<li><a href="/foo?page=6"   >6</a></li>' \
          '<li class="pagination-next"><a href="/foo?page=4"   rel="next" aria-label="next">Next&nbsp;&rsaquo;</a></li>' \
        '</ul>' \
      '</nav>'
    end
    ...
    it 'renders page 6' do
      ...
      frontend.pagy_nav_foundation(pagy).must_equal \
       '<nav class="pagy-nav-foundation" aria-label="Pagination">' \
        '<ul class="pagination">' \
          '<li class="pagination-previous"><a href="/foo?page=5"   rel="prev" aria-label="previous">&lsaquo;&nbsp;Prev</a></li>' \
          '<li><a href="/foo?page=1"   >1</a></li>' \
          ...
          '<li class="pagination-next disabled">Next&nbsp;&rsaquo;</li>' \
        '</ul>' \
      '</nav>'
    end
    ...
    it 'renders page 10' do
      ...
      frontend.pagy_nav_foundation(pagy).must_equal \
        '<nav class="pagy-nav-foundation" aria-label="Pagination">' \
          '<ul class="pagination">' \
            '<li class="pagination-previous"><a href="/foo?page=9"   rel="prev" aria-label="previous">&lsaquo;&nbsp;Prev</a></li>' \
            '<li><a href="/foo?page=1"   >1</a></li>' \
            ...
            '<li class="pagination-next"><a href="/foo?page=11"   rel="next" aria-label="next">Next&nbsp;&rsaquo;</a></li>' \
          '</ul>' \
        '</nav>'
    end
