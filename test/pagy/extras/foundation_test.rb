...
describe 'pagy/extras/foundation' do
  ...
  describe '#pagy_foundation_nav' do
    it 'renders first page' do
      ...
      _(app.pagy_foundation_nav(pagy)).must_rematch :plain
      _(app.pagy_foundation_nav(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra')).must_rematch :extras
    end
  ...
  describe '#pagy_foundation_nav_js' do
    it 'renders first page' do
      pagy = Pagy.new(size: [1, 4, 4, 1], count: 1000, page: 1)
      _(app.pagy_foundation_nav_js(pagy)).must_rematch :plain
  ...
  describe '#pagy_foundation_combo_nav_js' do
    it 'renders first page' do
      ...
      _(app.pagy_foundation_combo_nav_js(pagy)).must_rematch :plain
      _(app.pagy_foundation_combo_nav_js(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra')).must_rematch :extras
    end
    it 'renders intermediate page' do
