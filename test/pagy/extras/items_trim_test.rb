...
describe 'pagy/extras/items_trim' do
  ...
  it 'renders items selector with trim' do
    ...
    _(view.pagy_items_selector_js(pagy, pagy_id: 'test-id')).must_equal \
      "<span id=\"test-id\" class=\"pagy-items-selector-js\"><label>Show <input type=\"number\" min=\"1\" max=\"100\" value=\"20\" style=\"padding: 0; text-align: center; width: 3rem;\"> items per page</label></span><script type=\"application/json\" class=\"pagy-json\">[\"items_selector\",41,\"<a href=\\\"/foo?page=__pagy_page__&items=__pagy_items__\\\"   style=\\\"display: none;\\\"></a>\",\"page\"]</script>"
    _(view.pagy_items_selector_js(pagy, pagy_id: 'test-id', item_name: 'products')).must_equal \
      "<span id=\"test-id\" class=\"pagy-items-selector-js\"><label>Show <input type=\"number\" min=\"1\" max=\"100\" value=\"20\" style=\"padding: 0; text-align: center; width: 3rem;\"> products per page</label></span><script type=\"application/json\" class=\"pagy-json\">[\"items_selector\",41,\"<a href=\\\"/foo?page=__pagy_page__&items=__pagy_items__\\\"   style=\\\"display: none;\\\"></a>\",\"page\"]</script>"
