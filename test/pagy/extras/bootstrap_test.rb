  ...
  describe "#pagy_bootstrap_nav" do
    ...
    it 'renders first page' do
      ...
      frontend.pagy_bootstrap_nav(pagy).must_equal \
        "<nav class=\"pagy-bootstrap-nav pagination\" role=\"navigation\" aria-label=\"pager\"><ul class=\"pagination\"><li class=\"page-item prev disabled\"><a href=\"#\" class=\"page-link\">&lsaquo;&nbsp;Prev</a></li><li class=\"page-item active\"><a href=\"/foo?page=1\"  class=\"page-link\" >1</a></li><li class=\"page-item\"><a href=\"/foo?page=2\"  class=\"page-link\" rel=\"next\" >2</a></li><li class=\"page-item\"><a href=\"/foo?page=3\"  class=\"page-link\" >3</a></li><li class=\"page-item\"><a href=\"/foo?page=4\"  class=\"page-link\" >4</a></li><li class=\"page-item\"><a href=\"/foo?page=5\"  class=\"page-link\" >5</a></li><li class=\"page-item\"><a href=\"/foo?page=6\"  class=\"page-link\" >6</a></li><li class=\"page-item next\"><a href=\"/foo?page=2\"  class=\"page-link\" rel=\"next\" aria-label=\"next\">Next&nbsp;&rsaquo;</a></li></ul></nav>"
    end

    it 'renders intermediate page' do
      pagy = Pagy.new(count: 103, page: 3)
      frontend.pagy_bootstrap_nav(pagy).must_equal \
        "<nav class=\"pagy-bootstrap-nav pagination\" role=\"navigation\" aria-label=\"pager\"><ul class=\"pagination\"><li class=\"page-item prev\"><a href=\"/foo?page=2\"  class=\"page-link\" rel=\"prev\" aria-label=\"previous\">&lsaquo;&nbsp;Prev</a></li><li class=\"page-item\"><a href=\"/foo?page=1\"  class=\"page-link\" >1</a></li><li class=\"page-item\"><a href=\"/foo?page=2\"  class=\"page-link\" rel=\"prev\" >2</a></li><li class=\"page-item active\"><a href=\"/foo?page=3\"  class=\"page-link\" >3</a></li><li class=\"page-item\"><a href=\"/foo?page=4\"  class=\"page-link\" rel=\"next\" >4</a></li><li class=\"page-item\"><a href=\"/foo?page=5\"  class=\"page-link\" >5</a></li><li class=\"page-item\"><a href=\"/foo?page=6\"  class=\"page-link\" >6</a></li><li class=\"page-item next\"><a href=\"/foo?page=4\"  class=\"page-link\" rel=\"next\" aria-label=\"next\">Next&nbsp;&rsaquo;</a></li></ul></nav>"
    end

    it 'renders last page' do
      pagy = Pagy.new(count: 103, page: 6)
      frontend.pagy_bootstrap_nav(pagy).must_equal \
        "<nav class=\"pagy-bootstrap-nav pagination\" role=\"navigation\" aria-label=\"pager\"><ul class=\"pagination\"><li class=\"page-item prev\"><a href=\"/foo?page=5\"  class=\"page-link\" rel=\"prev\" aria-label=\"previous\">&lsaquo;&nbsp;Prev</a></li><li class=\"page-item\"><a href=\"/foo?page=1\"  class=\"page-link\" >1</a></li><li class=\"page-item\"><a href=\"/foo?page=2\"  class=\"page-link\" >2</a></li><li class=\"page-item\"><a href=\"/foo?page=3\"  class=\"page-link\" >3</a></li><li class=\"page-item\"><a href=\"/foo?page=4\"  class=\"page-link\" >4</a></li><li class=\"page-item\"><a href=\"/foo?page=5\"  class=\"page-link\" rel=\"prev\" >5</a></li><li class=\"page-item active\"><a href=\"/foo?page=6\"  class=\"page-link\" >6</a></li><li class=\"page-item next disabled\"><a href=\"#\" class=\"page-link\">Next&nbsp;&rsaquo;</a></li></ul></nav>"
    end
