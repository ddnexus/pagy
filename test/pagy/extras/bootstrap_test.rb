...
describe 'pagy/extras/bootstrap' do
  ...
  describe '#pagy_bootstrap_nav_js' do
    it 'renders first page' do
      pagy = Pagy.new(count: 1000, page: 1)
      _(view.pagy_bootstrap_nav_js(pagy)).must_rematch
      _(view.pagy_bootstrap_nav_js(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra',
    ...
    it 'raises with missing step 0' do
      ...
      _ { view.pagy_bootstrap_nav_js(pagy, steps: { 600 => [1, 3, 3, 1] }) }.must_raise Pagy::VariableError
    end
  end
  ...
  describe '#pagy_bootstrap_combo_nav_js' do
    it 'renders first page' do
      ...
      _(view.pagy_bootstrap_combo_nav_js(pagy)).must_rematch
      _(view.pagy_bootstrap_combo_nav_js(pagy, pagy_id: 'test-nav-id', link_extra: 'link-extra')).must_rematch
    end
    it 'renders intermediate page' do
