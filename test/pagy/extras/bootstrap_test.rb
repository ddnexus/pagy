...
describe Pagy::Frontend do
  ...
  describe "#pagy_bootstrap_nav" do
    ...
    it 'renders page 1' do
      ...
      frontend.pagy_bootstrap_nav(pagy).must_equal \
        '<nav class="pagy-nav-bootstrap pagy-bootstrap-nav pagination" role="navigation" aria-label="pager">' \
          '<ul class="pagination">' \
  ...
  describe "#pagy_bootstrap_compact_nav" do
    ...
    it 'renders page 6 for bootstrap' do
      ...
      html = frontend.pagy_bootstrap_compact_nav(pagy, pagy_test_id)
      html.must_equal \
        "<nav id=\"pagy-nav-#{pagy_test_id}\" class=\"pagy-nav-compact-bootstrap pagy-bootstrap-compact-nav pagination\" role=\"navigation\" aria-label=\"pager\"><a href=\"/foo?page=#{Pagy::Frontend::MARKER}\"   style=\"display: none;\" ></a><div class=\"btn-group\" role=\"group\"><a href=\"/foo?page=5\"   rel=\"prev\" aria-label=\"previous\" class=\"prev btn btn-primary\">&lsaquo;&nbsp;Prev</a><div class=\"pagy-compact-input btn btn-primary disabled\">Page <input type=\"number\" min=\"1\" max=\"6\" value=\"6\" class=\"text-primary\" style=\"padding: 0; border: none; text-align: center; width: 2rem;\"> of 6</div><a class=\"next btn btn-primary disabled\" href=\"#\">Next&nbsp;&rsaquo;</a></div></nav><script type=\"application/json\" class=\"pagy-compact-json\">[\"#{pagy_test_id}\", \"#{Pagy::Frontend::MARKER}\", \"6\", false]</script>"
    end
