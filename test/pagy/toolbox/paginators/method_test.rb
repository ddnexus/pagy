...
describe 'paginators jsonapi' do
  ...
  describe 'JSON:API' do
    it 'uses the :jsonapi with page:nil' do
      ...
      pagy, _records = app.pagy(:offset, @collection, jsonapi: true)
  ...
  describe 'Skip :jsonapi' do
    it 'skips the :jsonapi with page:nil' do
      ...
      pagy, _records = app.pagy(:offset, @collection, client_max_limit: 100)
    ...
    it 'skips the :jsonapi with page:3' do
      ...
      pagy, _records = app.pagy(:offset, @collection, **@pagy_default, jsonapi: false)
