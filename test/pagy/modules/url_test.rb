...
describe 'pagy/helpers/url' do
  ...
  describe 'pagy query_utils' do
    ...
    it 'handles unescaped params' do
      _(Pagy::Linkable::QueryUtils.build_nested_query({ b: { 'c' => Pagy::EscapedValue.new(' A ') } })).must_equal "b%5Bc%5D= A " # "a[b][c]=3"
      _(Pagy::Linkable::QueryUtils.build_nested_query({ a: { b: { 'c' => Pagy::EscapedValue.new(' A ') } } })).must_equal "a%5Bb%5D%5Bc%5D= A " # "a[b][c]=3"
    end
