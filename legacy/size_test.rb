...
describe 'pagy/legacy/size' do
  describe '#series (size = Array)' do
    ...
    it 'computes series for count 0' do
      _(Pagy::Offset.new(**@vars3, count: 0).series).must_equal ['1']
    end
    it 'computes series for single page' do
      _(Pagy::Offset.new(**@vars3, count: 8).series).must_equal ['1']
    end
    it 'computes series for 1 of 2 pages' do
      _(Pagy::Offset.new(**@vars3, count: 15).series).must_equal ['1', 2]
    end
    it 'computes series for 2 of 2 pages' do
      _(Pagy::Offset.new(**@vars3, count: 15, page: 2).series).must_equal [1, '2']
    end
    it 'computes an empty series' do
      _(Pagy::Offset.new(**@vars3, count: 100, size: []).series).must_equal []
    end
    it 'use super for non array size' do
      _(Pagy::Offset.new(**@vars3, count: 100, size: 0).series).must_equal []
