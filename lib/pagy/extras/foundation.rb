...
class Pagy
  ...
  module Frontend
    ...
    def pagy_nav_foundation(pagy)
      ...
      html << (p_prev ? %(<li class="pagination-previous">#{link.call p_prev, pagy_t('pagy.nav.prev'), 'aria-label="previous"'}</li>)
                      : %(<li class="pagination-previous disabled">#{pagy_t('pagy.nav.prev')}</li>))
      ...
      html << (p_next ? %(<li class="pagination-next">#{link.call p_next, pagy_t('pagy.nav.next'), 'aria-label="next"'}</li>)
                      : %(<li class="pagination-next disabled">#{pagy_t('pagy.nav.next')}</li>))
