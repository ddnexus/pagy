...
+ gem 'pagy', '~> 43.5.1', require: 'pagy/next' # PATCH version restriction + pagy/next entry point
```
...
- Use a stricter PATCH version restriction (e.g., replace `~> 43.5` with `~> 43.5.1`)
